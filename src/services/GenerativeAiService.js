            ...
            chatSession = model.startChat({
                ...
                history: [
                    ...
                    },
                    {
                        role: "user",
                        parts: [{
                            text: "If the user asks for Charles' CV or resume, you can give this link, 'https://drive.google.com/file/d/1F9mFDSkkUjQFt48fktNbyKE0hePTFKLs/view?usp=sharing'. Make sure that the link is clickable and will direct the user to the drive so that we will not annoy them. Dont put parenthesis or bracket."
                        }],
                    },
                    {
                        role: "user",
